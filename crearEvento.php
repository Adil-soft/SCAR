<html lang="en">
   ...
   <body>
    ...
    <div class="col-md-12">
        <form method="post" action="confirmarEvento.php">
            <div class="form-group">
                <label for="id">ID del evento</label>
                <input type="number" name="id" id="idevento" class="form-control">
             </div>
            <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <textarea name="descripcion" cols="5" rows="5" id="descripcion" class="form-control"></textarea>
                </div>
            <div class="form-group">
                <input type="submit" name="submit" class="btn btn-primary" value="Crear Evento">
