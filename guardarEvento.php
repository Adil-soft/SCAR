...
<html lang="en">
   ...
   <body>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="titlepage">
                     <h2>El siguiente Evento Ha sido creado con Exito</h2>
    ...
    <div class="col-md-12">
        <form method="post" action="gestionEventos.php">
            ...
            <div class="form-group">
                <input type="submit" name="submit" class="btn btn-primary" value="Gestion De Eventos">
