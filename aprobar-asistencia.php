<?php
    include_once("leer-matriculados-sql.php");
			...
			<div class="row table-responsive">
				<table class="table table-striped">
                    ...
                    <?php while ($fils=$sql->fetch(PDO::FETCH_ASSOC)){?>
                           <tr>
                               <td><img src="<?php echo $fils['foto'];?>" alt="#" /></td>
                              ...
                              <td><?php echo $fils['correo']; ?></td>
                               ...
                               <td><a href="verificar-aprobar-asistencia.php?id=<?php echo $fils['id']; ?>" class="btn btn-success btn-sm rounded-pill py-0 editLink"  data-target="#publicar">Aprobar Asistencia</a></td>
